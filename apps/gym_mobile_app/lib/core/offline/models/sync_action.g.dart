...
const SyncActionSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'status': PropertySchema(
      ...
      name: r'status',
      type: IsarType.string,
      enumMap: _SyncActionstatusEnumValueMap,
    )
  },
...
SyncAction _syncActionDeserialize(
  ...
  object.status =
      _SyncActionstatusValueEnumMap[reader.readStringOrNull(offsets[6])] ??
          SyncStatus.pending;
  return object;
}
...
P _syncActionDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 6:
      return (_SyncActionstatusValueEnumMap[reader.readStringOrNull(offset)] ??
...
const _SyncActionstatusEnumValueMap = {
  r'pending': r'pending',
  r'syncing': r'syncing',
  r'failed': r'failed',
};
const _SyncActionstatusValueEnumMap = {
...
extension SyncActionQueryWhere
  ...
  QueryBuilder<SyncAction, SyncAction, QAfterWhereClause> actionTypeEqualTo(
      String actionType) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncAction, SyncAction, QAfterWhereClause> actionTypeNotEqualTo(
      String actionType) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension SyncActionQueryFilter
  ...
  QueryBuilder<SyncAction, SyncAction, QAfterFilterCondition> statusEqualTo(
    SyncStatus value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncAction, SyncAction, QAfterFilterCondition> statusGreaterThan(
    SyncStatus value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<SyncAction, SyncAction, QAfterFilterCondition> statusLessThan(
    SyncStatus value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<SyncAction, SyncAction, QAfterFilterCondition> statusBetween(
    SyncStatus lower,
    SyncStatus upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<SyncAction, SyncAction, QAfterFilterCondition> statusStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncAction, SyncAction, QAfterFilterCondition> statusEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncAction, SyncAction, QAfterFilterCondition> statusContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<SyncAction, SyncAction, QAfterFilterCondition> statusMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<SyncAction, SyncAction, QAfterFilterCondition> statusIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'status',
        value: '',
...
extension SyncActionQuerySortBy
  ...
  QueryBuilder<SyncAction, SyncAction, QAfterSortBy> sortByLastAttemptAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastAttemptAt', Sort.asc);
    });
  }

  QueryBuilder<SyncAction, SyncAction, QAfterSortBy> sortByLastAttemptAtDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncAction, SyncAction, QAfterSortBy> sortByStatus() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'status', Sort.asc);
    });
  }

  QueryBuilder<SyncAction, SyncAction, QAfterSortBy> sortByStatusDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension SyncActionQuerySortThenBy
  ...
  QueryBuilder<SyncAction, SyncAction, QAfterSortBy> thenByLastAttemptAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastAttemptAt', Sort.asc);
    });
  }

  QueryBuilder<SyncAction, SyncAction, QAfterSortBy> thenByLastAttemptAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastAttemptAt', Sort.desc);
    });
  }
  ...
  QueryBuilder<SyncAction, SyncAction, QAfterSortBy> thenByStatus() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'status', Sort.asc);
    });
  }

  QueryBuilder<SyncAction, SyncAction, QAfterSortBy> thenByStatusDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'status', Sort.desc);
    });
  }
...
extension SyncActionQueryWhereDistinct
  ...
  QueryBuilder<SyncAction, SyncAction, QDistinct> distinctByLastAttemptAt() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncAction, SyncAction, QDistinct> distinctByStatus(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension SyncActionQueryProperty
  ...
  QueryBuilder<SyncAction, DateTime?, QQueryOperations>
  ...
  QueryBuilder<SyncAction, SyncStatus, QQueryOperations> statusProperty() {
    return QueryBuilder.apply(this, (query) {
